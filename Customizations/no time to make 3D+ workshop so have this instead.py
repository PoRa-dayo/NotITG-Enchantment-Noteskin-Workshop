...
path = input("\033[91mNOTE: 3D+ NOTESKINS CAN CAUSE UNEXPECTED BEHAVIORS ON NotITG MODCHARTS OR ITS PORTS!!!\n\033[92m>>> Behold, the 3D+-ify-inator!\n>>> This script will replace an arrow/lift Milkshape ASCII.txt file from a 3D noteskin with a 3D+ version of it.\nEnter path to the arrow/lift Milkshape ASCII .txt file (in this case it's enchantmesh.txt or leviosa_mesh.txt): \033[0m ").strip('"')
